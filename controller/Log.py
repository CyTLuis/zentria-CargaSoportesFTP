...
class Log:
    ...
    def registroInicioProcesos(self):
        ...
        message = "============================================================================================================================\n"
        message+= f"| INICIO DE APLICACIÓN - {config.getConfigValue("enviroment", "nombreAutomatizacion")} - {str(self.gettiempoActual())} |\n"
        message+= "============================================================================================================================\n"
    ...
    def registroFinalProcesos(self):
        ...
        self.settiempoActual((datetime.today() - timedelta(hours = 0)).strftime('%Y-%m-%d %H:%M:%S'))
        log = "============================================================================================================================\n"
        log+= f"| FINAL DE APLICACIÓN - {config.getConfigValue("enviroment", "nombreAutomatizacion")} - {str(self.gettiempoActual())} |\n"
        log+= "============================================================================================================================\n"
        file = open(config.getConfigValue("routes", "UbicacionLogProceso") + self.__nombreArchivoProceso, "a")
        file.write(log + "\n") 
        file.close()
    ...
    def registrarLogError(self, error, procesoActual):
        """
